...
orphan_checker_args = [
    ...
    # Packages
    ("BlendNodeBlendMeasurePackages", "id", "SupplyCasesData", "blend_package_id"),
    ("DemandFuelSwitchingMeasurePackages", "id", "DemandCasesData", "fuel_switching_package_id"),
    ("DemandFlexibleLoadMeasurePackages", "id", "DemandCasesData", "flexible_load_package_id"),
    ("DemandServiceDemandMeasurePackages", "id", "DemandCasesData", "service_demand_package_id"),
    ("DemandStockMeasurePackages", "id", "DemandCasesData", "stock_package_id"),
    ("DemandEnergyEfficiencyMeasurePackages", "id", "DemandCasesData", "energy_efficiency_package_id"),
    ("DemandSalesMeasurePackages", "id", "DemandCasesData", "sales_package_id"),
    ("SupplySalesShareMeasurePackages", "id", "SupplyCasesData", "sales_share_package_id"),
    ("SupplyExportMeasurePackages", "id", "SupplyCasesData", "export_package_id"),
    ("SupplySalesMeasurePackages", "id", "SupplyCasesData", "sales_package_id"),
    ("SupplyStockMeasurePackages", "id", "SupplyCasesData", "stock_package_id"),
    # Measures
