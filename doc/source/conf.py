# -*- coding: utf-8 -*-
#
# energyPATHWAYS documentation build configuration file, created by
# sphinx-quickstart on Thu May 12 15:05:02 2016.
#
...
extensions = [
    ...
    'sphinx.ext.coverage',   # http://www.sphinx-doc.org/en/stable/ext/coverage.html
    #'sphinx.ext.inheritance_diagram', # http://www.sphinx-doc.org/en/stable/ext/inheritance.html
]
...
htmlhelp_basename = 'energyPATHWAYSdoc'
...
latex_documents = [
    (master_doc, 'energyPATHWAYS.tex', u'energyPATHWAYS Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'energypathways', u'energyPATHWAYS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'energyPATHWAYS', u'energyPATHWAYS Documentation',
     author, 'energyPATHWAYS', 'One line description of project.',
     'Miscellaneous'),
]
