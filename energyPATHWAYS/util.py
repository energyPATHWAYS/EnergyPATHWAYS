...
def sql_read_table(table_name, column_names='*', return_unique=False, return_iterable=False, **filters):
    ...
    Returns a list of tuples, a list of single values, or a single value, depending
    on return_iterable and the number of columns in the result.
    ...
    if len(filters):
        ...
        try:
            ...
            raise Exception("Table name {}, col names {}, datatypes {}".format(table_name, column_names, datatypes))
