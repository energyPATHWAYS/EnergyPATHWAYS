...
class FlexibleLoadMeasure2(Abstract):
    def __init__(self, perturbation):
        ...
        self.input_type = 'intensity'
        self.geography = GeoMapper.demand_primary_geography # the perturbations come in already geomapped
        self.remap(converted_geography=GeoMapper.demand_primary_geography)
    ...
    def perturbation_to_raw_values(self, perturbation):
        ...
        raw_values = raw_values.groupby(level=['demand_technology', GeoMapper.demand_primary_geography, 'year']).mean()
        ...
        raw_values = raw_values.set_index(['demand_technology', GeoMapper.demand_primary_geography, 'year'])
