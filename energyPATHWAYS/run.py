...
if __name__ == "__main__":
    ...
    pint = 'unit_defs.txt'
    scenario = [1]
    run(workingdir, config, pint, scenario, load_demand=True, solve_demand=True, load_supply=False, solve_supply=True, pickle_shapes=True, save_models=False, api_run=False, clear_results=True)
