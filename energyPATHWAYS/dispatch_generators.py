...
pmaxs2 = increase_pmax_with_capacity_weights(pmaxs, capacity_weights)    maintenance_rates = dispatch_maintenance.schedule_generator_maintenance(load=load, pmaxs=pmaxs2, annual_maintenance_rates=MOR, dispatch_periods=weeks, marginal_costs=marginal_costs)
